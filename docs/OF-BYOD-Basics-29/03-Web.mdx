...
5. Sie können erklären, wozu man Bookmarks braucht. Sie können in Ihrem Browser ein Bookmark erstellen und bearbeiten und können Webseiten über Bookmarks öffnen. Sie haben für Ihre Informatik-Klassen-Startseite ein Bookmark erstellt.
...
4
: **Favoritenleiste**
: Hier können für regelmässig benötigte Webseiten (z.B. ihre Informatik-Klassen-Startseite) [Bookmarks](#bookmarks) anlegen, um sie schnell zu erreichen.
5
: **Navigation**
: Zurück und vorwärts.
6
...
Hier der Vergleich für die Website `inf.gbsl.website`:
...
Von vielen Webseiten wissen Sie die URL vermutlich auswendig: trb.gbsl.website, gbsl.ch, youtube.com, instagram.com, etc. Geben Sie diese URLs immer gleich direkt in die Adressleiste ein. Das spart Zeit und Klicks.
:::
...
- `trb.gbsl.website` (die Domain-Endung ist hier `.website`)
...
:::aufgabe[Bookmark für trb.gbsl.website erstellen]
